    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-xs space-y-4 mb-16">
        <Button
          ...
          className="w-full h-14 bg-white hover:bg-gray-50 text-black font-medium rounded-full border border-gray-200 transition-colors"
        >
        ...
        <Button
          ...
          className="w-full h-14 bg-bitwave-orange hover:bg-bitwave-gold text-black font-medium rounded-full transition-colors"
        >
          <svg className="mr-3 h-5 w-5" viewBox="0 0 24 24">
            <path
              fill="currentColor"
